...
| Resize down  | <kbd>lctrl</kbd> + <kbd>alt</kbd> + <kbd>e</kbd> |
| Resize up    | <kbd>lctrl</kbd> + <kbd>alt</kbd> + <kbd>n</kbd> |
| Resize right | <kbd>lctrl</kbd> + <kbd>alt</kbd> + <kbd>i</kbd> |
| Equalise     | <kbd>lctrl</kbd> + <kbd>alt</kbd> + <kbd>s</kbd> |

### Move Windows

<kbd>shift</kbd> + <kbd>alt</kbd> + <kbd>hnei</kbd>
...
| Insert down  | <kbd>shift</kbd> + <kbd>lctrl</kbd> + <kbd>alt</kbd> + <kbd>n</kbd> |
| Insert up    | <kbd>shift</kbd> + <kbd>lctrl</kbd> + <kbd>alt</kbd> + <kbd>e</kbd> |
| Insert right | <kbd>shift</kbd> + <kbd>lctrl</kbd> + <kbd>alt</kbd> + <kbd>i</kbd> |
